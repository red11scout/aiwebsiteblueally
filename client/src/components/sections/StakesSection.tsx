...
export default function StakesSection() {
  ...
  return (
    <section id="stakes" className="py-20 md:py-32 bg-background" ref={ref}>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {pitfalls.map((pitfall, index) => (
              <motion.div
                ...
                className="bg-card rounded-xl p-6 border border-border hover:border-[#00A3E0]/50 transition-all duration-300 group"
              >
